...
INSERT INTO person (user_userId, firstName, lastName, dateOfBirth, gender, phone, email, about, idAddress) VALUES (1, 'Jan', 'Nowak', '1980-01-01', true, 123456789, 'example@email.com', 'lubie placki', 1);
...
INSERT INTO responsibility (2, 'Czyszczenie toalet');
INSERT INTO responsibility (2, 'Mycie podłogi');
...
INSERT INTO addresss (idPerson_idPerson, street, houseNumber, apartmentNumber, postcode, city) VALUES (1, 'Programistyczna', 1, 666, 00-000, 'Wrocław');